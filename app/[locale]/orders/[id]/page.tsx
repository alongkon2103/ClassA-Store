            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
                    ...
                    <div className="lg:col-span-8 space-y-6 md:space-y-8">
                        ...
                        {/* Discord community — recommend joining the store server */}
                        <a
                            href={STORE_DISCORD_URL}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block rounded-2xl md:rounded-3xl border border-accent/10 bg-bg-card hover:border-accent/25 transition-colors p-5 md:p-6"
                        >
                            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                <span className="w-12 h-12 rounded-xl bg-[#5865F2] flex items-center justify-center shrink-0 text-white">
                                    <DiscordIcon size={26} />
                                </span>
