        ...
        <section className="bg-bg-base px-10 py-20 text-center border-t border-accent/20">
            <div className="max-w-md mx-auto">
                ...
                <div className="w-14 h-14 mx-auto mb-5 flex items-center justify-center 
                                rounded-2xl bg-[#5865F2] hover:bg-[#4752C4] 
                ...
                {/* TITLE */}
                <h2 className="font-display font-bold mb-3 text-[clamp(26px,4vw,40px)]">
                    {t("join_discord")}
                </h2>
                ...
                <div className="flex gap-6 justify-center flex-wrap mt-7">
                    {[
                        ...
                        <span key={item} className="text-[12px] text-text-muted flex items-center gap-1.5">
