...
export default function KeyModal({ order, isOpen, onClose }: KeyModalProps) {
  ...
  return (
    <div
      className="overlay fixed inset-0 z-50 flex items-center justify-center px-4 fade-in"
      onClick={onClose}
    >
      <div
        className="popup-card popup-anim rounded-3xl w-full max-w-[480px] overflow-hidden"
      ...
      >
        ...
        <div className="p-6">
          ...
          <button
            onClick={onClose}
            className="w-full py-3 rounded-xl text-[14px] font-medium bg-[rgba(66,122,181,.12)] border border-[var(--color-border-soft)] text-text-muted"
          >
            Close
          </button>
        </div>
