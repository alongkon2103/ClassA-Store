...
//
// เมนู Coins/Points ในดีไซน์ยังไม่ใส่ — รอระบบแต้ม (ทำเป็นเฟสแยก)
import { useSession, signOut } from "next-auth/react"
import { useTranslations } from "next-intl"
import { Link } from "@/i18n/routing"

export type AccountSection = "account" | "orders" | "coupons" | "reviews" | "favorites"
...
export default function AccountShell({ active, children }: { active: AccountSection; children: React.ReactNode }) {
